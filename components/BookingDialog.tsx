      ...
      <DialogContent className="max-w-5xl h-[90vh] overflow-y-auto bg-gradient-to-br from-white to-gray-50">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-3 mt-6">
            <input
              type="checkbox"
              className="w-5 h-5 rounded border-gray-300 text-[#ff4d30] 
                       focus:ring-[#ff4d30]/20"
            />
            <label className="text-sm text-gray-600">
              Je souhaite recevoir les dernières offres et actualités
            </label>
          </div>
          ...
          <div className="pt-6 mt-8 border-t">
            <Button
              ...
              className="w-full py-6 bg-gradient-to-r from-[#ff4d30] to-orange-600 
                       hover:from-[#ff4d30] hover:to-[#ff4d30] text-white font-semibold
                       rounded-lg transition-all duration-300 shadow-lg
                       hover:shadow-[#ff4d30]/30"
            >
              Finaliser la réservation
            </Button>
          </div>
