  ...
  return (
    <section className="py-32 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          <span className="text-[#ff4d30] font-bold text-xl mb-2 block">
            FAQ
          </span>
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {faqData.map((faq) => (
            <motion.div
              ...
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg mb-4 transition-all duration-300"
              style={{
            ...
            >
              ...
              <AnimatePresence>
                {activeQ === faq.id && (
                  ...
                  >
                    <div className="p-6 bg-white text-gray-600 text-lg leading-relaxed border-t">
                      {faq.answer}
                    </div>
                  </motion.div>
                )}
